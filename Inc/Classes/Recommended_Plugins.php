...
use JLTWPORGST\Libs\Recommended;
	...
	class Recommended_Plugins extends Recommended {
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'options-general.php',       // Ex. wp-org-plugin-stats-settings /  edit.php?post_type=page .
				__( 'Recommended', 'wp-org-plugin-stats' ),
				__( 'Recommended', 'wp-org-plugin-stats' ),
				'manage_options',
				'wp-org-plugin-stats-recommended-plugins',
